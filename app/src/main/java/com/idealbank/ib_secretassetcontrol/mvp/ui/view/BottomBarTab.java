...
public class BottomBarTab extends FrameLayout {
    ...
    public BottomBarTab( Context context,int icon, int unselectedicon,CharSequence title) {
        super(context);
        this.context=context;
        this.icon=icon;
        this.unselectedicon=unselectedicon;
        this.title=title;
        init(context, icon,unselectedicon, title);
...
//        //省略了一堆代码
//    }
//    public BottomBarTab(Context context, @DrawableRes int icon,@DrawableRes int unselectedicon, CharSequence title) {
...
//    }
//
//    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon, int unselectedicon,CharSequence title) {
//        super(context, attrs, defStyleAttr);
//        init(context, icon,unselectedicon, title);
//    }

    private void init(Context context, int icon, int unselectedicon, CharSequence title) {
        mContext = context;
        ...
        mIcon.setImageResource(unselectedicon);
