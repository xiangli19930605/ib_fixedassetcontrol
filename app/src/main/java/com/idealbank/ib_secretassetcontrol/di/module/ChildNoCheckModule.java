...
import com.idealbank.ib_secretassetcontrol.mvp.model.ChildNoCheckModel;
 ...
 */
@Module
public abstract class ChildNoCheckModule {

    @Binds
    abstract ChildNoCheckContract.Model bindChildNoCheckModel(ChildNoCheckModel model);
