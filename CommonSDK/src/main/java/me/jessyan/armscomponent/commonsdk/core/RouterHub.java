...
public interface RouterHub {
     ...
     * 知乎分组
     */
    String MAIN_SERVICE_MAINEINFOSERVICE = MAIN + SERVICE + "/ZhihuInfoService";

    String MAIN_MAINEACTIVITY = MAIN + "/MainActivity";
    String MAIN_DETAILACTIVITY = MAIN + "/DetailActivity";
    /**
     * gank分组
     */
    String GANK_SERVICE_GANKEINFOSERVICE = GANK + SERVICE + "/ZhihuInfoService";
    String GANK_GANKACTIVITY = GANK + "/MainActivity";
    String GANK_DETAILACTIVITY = GANK + "/DetailActivity";
